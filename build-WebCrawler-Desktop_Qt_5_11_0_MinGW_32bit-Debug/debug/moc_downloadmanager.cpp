...
QT_MOC_LITERAL(3, 26, 19), // "oneDownloadFinished"
QT_MOC_LITERAL(4, 46, 17), // "startNextDownload"
QT_MOC_LITERAL(5, 64, 16), // "downloadProgress"
QT_MOC_LITERAL(6, 81, 13), // "bytesReceived"
QT_MOC_LITERAL(7, 95, 10), // "bytesTotal"
QT_MOC_LITERAL(8, 106, 16), // "downloadFinished"
QT_MOC_LITERAL(9, 123, 17) // "downloadReadyRead"

    },
    "DownloadManager\0finished\0\0oneDownloadFinished\0"
...
void DownloadManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->oneDownloadFinished(); break;
        ...
        {
            using _t = void (DownloadManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DownloadManager::oneDownloadFinished)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void DownloadManager::oneDownloadFinished()
{
